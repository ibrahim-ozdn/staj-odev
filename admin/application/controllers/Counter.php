...
class Counter extends CI_Controller
{
    ...
    public function index(){
        ...
        $items = $this->counter_model->get_all(
            array(), "rank ASC"
        );
        $this->load->helper("text");

        $viewData->viewFolder    = $this->viewFolder;
        $viewData->pageTitle     = "Counters";
    ...
    public function new_form(){
        ...
        $viewData->viewFolder    = $this->viewFolder;
        $viewData->pageTitle     = "Add Counter";
    ...
    public function save(){
        ...
        $this->form_validation->set_rules("title", "Counter Name", "required|trim");
    ...
    public function update($id){
        ...
        if($validate){
            ...
            $update = $this->counter_model->update(
                array(
                    "id" => $id
                ),
                array(
    ...
    public function delete($id){
        ...
        $delete = $this->counter_model->delete(
            array(
                "id" => $id
            )
        );
