...
class Contact_settings extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->viewFolder = "page_settings_view/contact_settings_view";
    ...
    public function index(){
        ...
        $item = $this->contact_settings_model->get();
        ...
        $viewData->pageTitle  = "Contact Area Settings";
        $viewData->item = $item;
    ...
    public function new_form(){
        ...
        $viewData->viewFolder    = $this->viewFolder;
        $viewData->pageTitle     = "Add Contact Section";
    ...
    public function save(){
        ...
        if($validate){
            ...
            $insert = $this->contact_settings_model->add(
                array(
