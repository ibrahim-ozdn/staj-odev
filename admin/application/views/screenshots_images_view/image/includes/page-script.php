...
<script src="<?php echo base_url("assets"); ?>/js/plugin/switchery/dist/switchery.min.js"></script>
<script src="<?php echo base_url("assets"); ?>/js/plugin/dropzone/min/dropzone.min.js"></script>
