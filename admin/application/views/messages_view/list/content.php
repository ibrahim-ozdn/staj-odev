                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach($items as $item) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo character_limiter(strip_tags($item->name), 15); ?></td>
                                                <td><?php echo character_limiter(strip_tags($item->email), 45); ?></td>
                                                <td><?php echo character_limiter(strip_tags($item->subject), 45); ?></td>
                                                <td><?php echo character_limiter(strip_tags($item->message), 45); ?></td>
                                                <td><?php echo character_limiter(strip_tags($item->ip_address), 45); ?></td>
                                                <td class="wt-10">
                                                    <div class="btn-group" role="group">
                                                        <button data-url="<?php echo base_url("messages/delete/$item->id"); ?>" 
