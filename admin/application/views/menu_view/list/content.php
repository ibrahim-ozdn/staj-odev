        ...
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column pb-4 flex-md-row">
                ...
                <div class="ml-md-auto py-4 py-md-0">
                    <a href="menu/new_form" class="btn btn-light btn-round">Add New</a>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <tbody class="sortable" data-url="<?php echo base_url("menu/rankSetter"); ?>">
                                        ...
                                        <?php foreach($items as $item) { ?>
                                            ...
                                            <tr id="ord-<?php echo $item->id; ?>">
                                                ...
                                                <td><?php echo character_limiter(strip_tags($item->link), 45); ?></td>
                                                <td class="wt-10">
                                                    <input data-url="<?php echo base_url("menu/isActiveSetter/$item->id"); ?>"
                                                        class="isActive"
                                                        type="checkbox"
                                                        data-switchery
                                                        data-color="#10c469"
