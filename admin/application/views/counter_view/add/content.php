<div class="content">
    ...
    <div class="page-inner mt--5">
        <form action="<?php echo base_url("counter/save"); ?>" method="post">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                            class="form-control" 
                            name="color"
                            placeholder="Enter Count Color"
                            value="<?php echo isset($form_error) ? set_value("color") : ""; ?>">        
                    </div>
                    <div class="form-group">
                        <label>Icon</label>
                        <input type="text" 
                    ...
                    <a href="<?php echo base_url("counter"); ?>" class="btn btn-outline-danger mt-3">Back to Counters</a>
