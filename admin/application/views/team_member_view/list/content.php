        ...
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column pb-4 flex-md-row">
                ...
                <div class="ml-md-auto py-4 py-md-0">
                    <a href="team_member/new_form" class="btn btn-light btn-round">Add New</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body p-0">         
                            <div class="table-responsive">
                                <table id="basic-datatables" class="table table-bordered content-container">
                                    ...
                                    <tbody class="sortable" data-url="<?php echo base_url("team_member/rankSetter"); ?>">
                                        ...
                                        <?php foreach($items as $item) { ?>
                                            ...
                                            <tr id="ord-<?php echo $item->id; ?>">
                                                ...
                                                <td class="wt-10">
                                                    <input data-url="<?php echo base_url("team_member/isActiveSetter/$item->id"); ?>"
                                                        class="isActive"
                                                        type="checkbox"
                                                        data-switchery
                                                        data-color="#10c469"
                                                ...
                                                <td class="wt-10">
                                                    <div class="btn-group" role="group">
                                                        <a href="<?php echo base_url("team_member/update_form/$item->id"); ?>" 
                                                            class="btn btn-outline-secondary btn-sm" 
                                                            data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="far fa-edit"></i>                         
                                                        </a>
                                                        <button data-url="<?php echo base_url("team_member/delete/$item->id"); ?>" 
