<div class="content">
    ...
    <div class="page-inner mt--5">
        <form action="<?php echo base_url("social/update/$item->id"); ?>" method="post">
            <div class="row row-card-no-pd">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url("social"); ?>" class="btn btn-outline-danger mt-3">Back to Social Media</a>
